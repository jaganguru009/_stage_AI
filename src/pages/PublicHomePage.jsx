...
export function PublicHomePage() {
  return <main className="public-page">
    ...
    <section className="public-intro" id="why-stage"><p>NOT ANOTHER SOCIAL NETWORK</p><h2>Stage turns the work<br/>you make into a career<br/>you can carry.</h2><div><span>Every profile is a living playbill. Every production becomes a verified credit. Every connection can become the next collaboration.</span><Link to="/register">Step into Stage <b>→</b></Link></div></section>
